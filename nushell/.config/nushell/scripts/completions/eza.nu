export extern "eza" [
    ...
    --color: string            # When to use terminal colors, valid values: 'always' 'automatic(or auto in short, this is default)' 'never'
    --colour: string           # When to use terminal colours, valid values: 'always' 'automatic(or auto in short, this is default)' 'never'
    ...
    --icons: string            # When to display icons, valid values: 'always' 'automatic(or auto in short, this is default)' 'never' 
    ...
    --time(-t) -d: string      # Which timestamp field to list
